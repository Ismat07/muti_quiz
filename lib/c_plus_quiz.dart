...
var quiz = new Quiz_c_plus();

class Quiz_c_plus{

  var questions = [
    "1-   ‘cin’ is an __",
    "2-  A protected member of the class in accessible in",
    "3-  How many number of arguments can a destructor of a class receives?",
  ...
  var choices = [
    ...
    ["Only same class", "Same class and derived class", "Outside the class", "None of the above"],
    ["0", "1", "2", "None of the above"],
    ["Cache", "Heap", "Stack", "None of the above"],
    ["Abstraction", "Encapsulation", "Data hiding", "Hiding complexity"]
  ];

  var correctAnswers = ["Object", "Same class and derived class", "0", "Heap","Abstraction"];
}

class c_plus_quiz extends StatefulWidget{
  final int questionNumber,finalScore;
  c_plus_quiz({Key key, this.questionNumber, this.finalScore}) : super(key: key);
...
class Quiz1State extends State<c_plus_quiz> {
