...
var quiz = new Quiz_python();

class Quiz_python{

  var questions = [
    "1-  How can we generate random numbers in python using methods?",
    "2-  How to create a frame in Python?",
  ...
  var choices = [
    ...
    ["Frame = new.window()", "Frame = frame.new()", "Frame = Frame()", "Frame = window.new()  "],
    ["yes", "no", "machine dependent", "none of the mentioned"],
    ["_a = 1", "__a = 1", "__str__ = 1", "none of the mentioned"]
  ];

  var correctAnswers = ["All of the above", "Frame = Frame()", "yes", "none of the mentioned"];
}

class python_quiz extends StatefulWidget{
  final int questionNumber,finalScore;
  python_quiz({Key key, this.questionNumber, this.finalScore}) : super(key: key);
...
class Quiz1State extends State<python_quiz> {
